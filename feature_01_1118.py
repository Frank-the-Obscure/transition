...
f = open('join_1118.csv', encoding='utf-8')

output = open('features_1118.csv', 'w', encoding='utf-8')
...
f = open('predict_join_1118.csv', encoding='utf-8')

output = open('predict_features_1118.csv', 'w', encoding='utf-8')
